...
This matrix defines what `whpc-kit` must eventually support for each W-HPC manuscript. The kit should reproduce central results, not every exploratory run from the research workspace.

| Manuscript | Parts | Target command | Public artifact target |
| --- | --- | --- | --- |
...
## Required Contract Per Manuscript
...
6. Link back to the corresponding manuscript tables and figures.
